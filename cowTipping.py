...
class Background(pygame.sprite.Sprite):
	def __init__(self):
		super().__init__()
		self.bgimage = pygame.transform.scale(pygame.image.load(os.path.join('Assets', 'backgrounds.png')), (WIDTH, HEIGHT))
		self.bgY = 0
		self.bgX = 0
...
class EventHandler():
	...
	def next_stage(self):
		...
		pygame.time.set_timer(self.cow_generation, 1500 - (50 * self.stage))
